...
namespace Wireframe
{
    public class ReorderableListOfExcludeFileByRegexSelection : InternalReorderableList<AExcludePathsByRegex_UploadModifier.Selection>
    {
        protected override void DrawItem(Rect rect, int index, bool isActive, bool isFocused)
        {
            AExcludePathsByRegex_UploadModifier.Selection element = list[index];
        ...
        protected override AExcludePathsByRegex_UploadModifier.Selection CreateItem(int index)
        {
