...
namespace Wireframe
{
    internal struct TextFieldStyleScope : IDisposable
    {
        ...
        static TextFieldStyleScope()
        {
            standardStyle = new GUIStyle(GUI.skin.textField);
            standardStyle.alignment = TextAnchor.MiddleLeft;
            
            // Dark
            warningStyle = new GUIStyle(GUI.skin.textField);
            ...
            // Light
            warningStyleLight = new GUIStyle(GUI.skin.textField);
            ...
            errorStyleLight = new GUIStyle(GUI.skin.textField);
        ...
        public TextFieldStyleScope(bool warning, bool error)
        {
