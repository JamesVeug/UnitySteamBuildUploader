...
namespace Wireframe
{
    public partial class BuildConfig
    {
        ...
        public class PostUploadActionData
        {
            ...
            public ABuildAction BuildAction;
            ...
            public void Deserialize(Dictionary<string,object> data)
            {
                ...
                if (data.TryGetValue("actionType", out var actionTypeData))
                {
                    ...
                    {
                        if (Utils.CreateInstance(ActionType.Type, out BuildAction))
                        {
                            BuildAction.Deserialize(data["action"] as Dictionary<string, object>);
                        }
                    }
                    else
                    {
