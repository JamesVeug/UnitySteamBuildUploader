...
namespace Wireframe
{
    public class ReorderableListOfGoogleAppsPreferences : InternalReorderableList<GoogleConfig.GoogleApp>
    {
        ...
        protected override void DrawItem(Rect containerRect, int index, bool isActive, bool isFocused)
        {
            using (new EditorGUILayout.HorizontalScope())
            {
                ...
                GUI.Label(rect0, new GUIContent("Name", "Display name for this Google app. UI only — not sent to Google."));
                rect0.x += rect0.width;
                ...
                GUI.Label(rect0, new GUIContent("Token", "Google OAuth access/refresh token for this app."));
                rect0.x += rect0.width;
