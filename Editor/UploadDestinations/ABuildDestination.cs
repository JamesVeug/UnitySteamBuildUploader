...
namespace Wireframe
{
   internal abstract class ABuildDestination
    {
        protected float m_uploadProgress;
        protected string m_progressDescription;
        protected bool m_uploadInProgress;

        protected BuildUploaderWindow m_uploaderWindow;

        public ABuildDestination(BuildUploaderWindow uploaderWindow)
        {
            m_uploaderWindow = uploaderWindow;
        }
