namespace Wireframe
{
    ...
    {
        private const string tsFormatTooltip = "When sending a Slack message we receive a Timestamp of that message. If a formatName is provided then that TS can be used elsewhere in the Upload Task. eg: editing it as a post action.";
