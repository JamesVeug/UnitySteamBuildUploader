...
namespace Wireframe
{
    internal class ReorderableListOfExcludeFileByRegexSelection : InternalReorderableList<ExcludeFilesByRegex_BuildModifier.Selection>
    {
        protected override void DrawItem(Rect rect, int index, bool isActive, bool isFocused)
        {
            ...
            Rect rect0 = new Rect(rect.x, rect.y, Mathf.Min(20, rect.width / 2), rect.height);
            ...
            Rect rect1 = new Rect(rect0.x + rect0.width, rect.y, Mathf.Min(120, rect.width / 2), rect.height);
            ...
            Rect rect2 = new Rect(rect1.x + rect1.width + 20, rect.y, Mathf.Min(150, rect.width / 2), rect.height);
            ...
            Rect rect3 = new Rect(rect2.x + rect2.width + 10, rect.y, rect.width - rect1.width, rect.height);
